...
const DataFilter: React.FC<DataFilterProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow space-y-4">
      <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">Filter Data</h3>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            <label htmlFor="min-amount" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Min Amount</label>
            <input
              type="number"
              id="min-amount"
              value={minAmount}
          ...
          <div>
            <label htmlFor="max-amount" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Max Amount</label>
            <input
              type="number"
              id="max-amount"
              value={maxAmount}
        ...
        <button
          onClick={onReset}
          className="inline-flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md shadow-sm text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 w-full"
        >
          Reset Filters
        </button>
      </div>
