  ...
  return (
    <div className="bg-red-50 border-l-4 border-red-400 p-6 rounded-md shadow-md max-w-4xl mx-auto">
      <div className="flex">
        ...
        <div className="ml-4">
          <h3 className="text-xl font-bold text-red-800">Permissions Error</h3>
          <div className="mt-2 text-md text-red-700 space-y-4">
            ...
            <div className="bg-red-100 p-4 rounded-lg">
                <h4 className="font-bold text-lg text-red-800">How to Fix</h4>
                ...
                <ol className="list-decimal list-inside space-y-2 mt-2 pl-2">
                  <li>Open your project in the <a href="https://console.firebase.google.com/" target="_blank" rel="noopener noreferrer" className="underline font-bold hover:text-red-900">Firebase Console</a>.</li>
